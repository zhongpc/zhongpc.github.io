...
<span style="text-decoration: underline">Interested in pursuing a PhD in science?</span> We recommend you to watch the <a href="https://www.youtube.com/watch?v=gUa5CQ0yE6c&t=794s">Seminar</a> before application.  The talk from Prof. Silvija Gradecak-Garaj is particularly useful. The general requirements are listed as follows:
...
* Regardless of the above openings, we always encourage excellent candidates to apply for Postdoctoral Fellowships: 
    ...
    * Other fellowships are potentially available to apply (e.g., [LKY Fellowship](https://www.nus.edu.sg/research/odprt-home/fellowships/lee-kuan-yew-postdoctoral-fellowship) and [NUS Society of Fellows](https://cde.nus.edu.sg/mse/nus-society-of-fellows-nsof/)). Generally, successful candidates are expected to graduate from top universities or prestigious PhD programmes.
