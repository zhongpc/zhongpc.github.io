...
To achieve this, a sparse solution with hierarchy constraints (or structural sparsity) is required. We incorperate the idea of  mixded integer programming with lattice model to generate robust and predictive energy models.
